...
if __name__ == '__main__':
    ...
    parser.add_argument('--device-name', default='DEV0')
    parser.add_argument('--mapped-device-file', default='DEV0.xlmap', type=argparse.FileType('w', encoding='utf-8'))
    ...
    parser.add_argument('--doocs-address', default='TEST.DOOCS/DEV0/DEV0.0')
